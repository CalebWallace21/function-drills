...
function add (num1,num2){
  let num1Convert = Number(num1)
  let num2Convert = Number(num2)
...
let nameGreeting = nameCheck(`Caleb`)
...
const bestMovie = name =>{
  return `${name} is the best movie ever!`
}
console.log(bestMovie(`The Dark Knight`))
...
function uppercaseConverter(sentence){
  uppercase = sentence.toUpperCase()
  return uppercase
}
console.log(uppercaseConverter(sampleString))
